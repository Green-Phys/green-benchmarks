...
def test_energy_diffs_align_by_iter():
    classes = {"old": _cls({1: -10.0, 2: -12.0}, "cpu"),
               "old_gpu": _cls({1: -10.0, 2: -12.0}, "gpu"),
               "new": _cls({1: -10.0, 2: -12.0}, "cpu"),
               "new_gpu": _cls({1: -10.0, 2: -12.0 + 5e-7}, "gpu")}
...
def test_verdict_pass_when_cpu_gpu_agree():
    classes = {"old": _cls({1: -10.0}, "cpu"), "old_gpu": _cls({1: -10.0}, "gpu"),
               "new": _cls({1: -10.0}, "cpu"), "new_gpu": _cls({1: -10.0 + 1e-9}, "gpu")}
...
def test_verdict_suspect_when_control_breaks():
    classes = {"old": _cls({1: -10.0}, "cpu"), "old_gpu": _cls({1: -10.0 + 1e-3}, "gpu"),
               "new": _cls({1: -10.0}, "cpu"), "new_gpu": _cls({1: -10.0}, "gpu")}
